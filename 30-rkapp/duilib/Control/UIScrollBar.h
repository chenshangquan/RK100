...
namespace DuiLib
{
	...
	public:
		...
		void SetMosaicBk(bool bIsMosaicBk);;
...
///////////////////////////////////////////拼接相关
		...
		CDuiString m_strBkgTop;

		CDuiString m_strDownBottom;
		CDuiString m_strDownMiddle;
		CDuiString m_strDownTop;

		CDuiString m_strNormalBottom;
		CDuiString m_strNormalMiddle;
		CDuiString m_strNormalTop;

		CDuiString m_strNormalBtn1;
		CDuiString m_strNormalBtn2;

		CDuiString m_strDownBtn1;
		CDuiString m_strDownBtn2;

		CDuiString m_strMosaicSliderImg;
		bool m_bIsMosaicScroll;
	};
}
