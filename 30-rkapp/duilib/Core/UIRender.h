...
public:
	...
	static CGifImage* LoadGif(STRINGorID bitmap, LPCTSTR type = NULL, DWORD mask = 0);
    ...
    static bool DrawImageString(HDC hDC, CPaintManagerUI* pManager, const RECT& rcItem, const RECT& rcPaint, 
        LPCTSTR pStrImage, LPCTSTR pStrModify = NULL, bool bIsAlwaysChangeBk = false);
    static void DrawColor(HDC hDC, const RECT& rc, DWORD color);
    static void DrawGradient(HDC hDC, const RECT& rc, DWORD dwFirst, DWORD dwSecond, bool bVertical, int nSteps);
	static void DrawTextByGdiPlus(HDC hDC, CPaintManagerUI* pManager, RECT& rc, LPCTSTR pstrText, DWORD dwTextColor, int iFont, UINT uStyle);
	...
	//	bool xtiled 水平拉伸   bool ytiled 垂直拉伸  默认false为拉伸 GDI+方式绘制
	static bool DrawImageGDIPlus( HDC hDC, CPaintManagerUI* pManager, const RECT& rc, const RECT& rcPaint, SIZE sz,\
		Image* pImg, CPoint ptInCtl, RECT rcItem );
};
