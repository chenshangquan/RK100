...
#define DUI_MSGTYPE_CTRLSIZE               (_T("ctrlsize"))
...
#define DUI_MSGTYPE_WINDOWCREATE           (_T("windowcreate"))
#define DUI_MSGTYPE_WINDOWDESTROY          (_T("windowdestroy"))
#define DUI_MSGTYPE_WINDOWSIZE             (_T("windowsize"))
#define DUI_MSGTYPE_WINDOWMOVE             (_T("windowmove"))
...
#define DUI_MSGTYPE_DBCLICK				   (_T("dbclink"))

#define DUI_MSGTYPE_LETTERINDEX_CLICK	   (_T("letterindexclk"))//dyy 点击letter索引
#define DUI_MSGTYPE_ITEMDOWN 		       (_T("itemdown"))      //xcr 列表条目点击down 
//////////////////////////////////////////////////////////////////////////
...
#define  DUI_CTR_TOUCHLIST                       (_T("TouchList"))
...
#define  DUI_CTR_LETTERINDEX                     (_T("LetterIndex"))
...
#define  DUI_CTR_SLIDETABLAYOUT                  (_T("SlideTabLayout"))
